...
[R Suite](https://rsuite.io) was developed by [WLOG Solutions company](http://wlogsolutions.com) to make their development process reproducible. R Suite gives answers to the following challenges for any R based software solution:
