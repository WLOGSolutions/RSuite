...
## Package options
RSuite uses the following options to configure behaviour:

  * rsuite.user_templ_path: path to user's local default template folder
  * rsuite.cache_path: path to RSuite's cache folder
